        ...
        <div class="col-md-12">
            <div class="m-portlet m-portlet--metal m-portlet--head-solid-bg">
                ...
                <div class="m-portlet__body">
                    {{ Form::open(array('url' =>'contasPagar/'.$contaPagar->id.'/pagar')) }}
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <small>R$</small>{{ number_format($contaPagar->valorLiquido, 2) }}
                            </h2>
                        </div>
                        <div class="col-md-6">
                            <h5>
                            ...
                            <small>R$</small>{{ number_format($contaPagar->valorPago, 2) }}
                            </h2>
                        </div>
                    </div>

				<div class="row">
					<a href="{{ URL::to('contasPagar') }}"

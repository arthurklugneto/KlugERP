                    ...
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            <span class="m-portlet__head-icon m--font-transform-u" style="color:#302B3E;">
                                <i class="la la-gavel"></i><span style="margin:24px;">Pedidos</span>
                            </span>
                            <h3 class="m-portlet__head-text m--font-primary ">
                            <a href="{{ URL::to('pedido/create') }}" class="m-portlet__nav-link btn btn-dark m-btn m-btn--air">
                                    Novo Pedido
                                </a>
                            </h3>
                        </div>
                ...
                <table
					...
					<tbody>
						...
						<tr class="odd gradeX">
							...
							<td>
								<a href="{{ URL::to('pedido/'.$value->id.'/edit') }}"
